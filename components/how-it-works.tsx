  ...
  return (
    <section className="py-16 bg-[#0a2642] text-white" ref={ref}>
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto bg-[#0d2e4e] rounded-lg shadow-lg p-8">
            ...
            >
              {steps.map((step) => (
                <motion.div
                  ...
                  className="bg-[#0a2642] rounded-lg p-6 text-center relative shadow-lg hover:shadow-xl transition-shadow duration-300 hover:bg-[#0e3359] group"
                >
